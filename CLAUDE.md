...
새 작업을 시작하기 전에는 [docs/10_PROGRESS_LOG.md](docs/10_PROGRESS_LOG.md)를 확인한다.
...
OAuth, JWT, 관광공사 OpenAPI 연동, GPS 체크인, 자동 매칭, WebSocket 이벤트, 관리자 기능, 배포 자동화는 이후 단계에서 별도 승인 후 진행한다.
