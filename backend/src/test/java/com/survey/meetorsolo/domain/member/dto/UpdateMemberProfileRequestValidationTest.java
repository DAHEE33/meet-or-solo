...
class UpdateMemberProfileRequestValidationTest {
    ...
    void 여행_스타일이_null이면_검증에_실패한다() {
        var request = new UpdateMemberProfileRequest("닉네임", null, null, "FEMALE", "20S", null);
    ...
    void 여행_스타일이_비어_있으면_검증에_실패한다() {
        var request = new UpdateMemberProfileRequest("닉네임", null, null, "FEMALE", "20S", List.of());
    ...
    void 여행_스타일이_세_개를_초과하면_검증에_실패한다() {
        var request = new UpdateMemberProfileRequest(
                "닉네임", null, null, "FEMALE", "20S", List.of("RELAXED", "ACTIVE", "FOOD", "PHOTO")
        );
    ...
    void 중복된_여행_스타일이면_검증에_실패한다() {
        var request = new UpdateMemberProfileRequest(
                "닉네임", null, null, "FEMALE", "20S", List.of("FOOD", "FOOD")
        );
    ...
    void 허용되지_않은_여행_스타일이면_검증에_실패한다() {
        var request = new UpdateMemberProfileRequest(
                "닉네임", null, null, "FEMALE", "20S", List.of("UNKNOWN")
        );
