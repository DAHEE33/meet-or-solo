package com.survey.meetorsolo.domain.festival.history.controller;
...
@RestController
@RequestMapping("/api/members/me/check-ins")
public class CheckinHistoryController {

    private static final String ACCESS_TOKEN_COOKIE = "access_token";

    private final JwtProvider jwtProvider;
    private final CheckinHistoryService history;

    public CheckinHistoryController(JwtProvider jwtProvider, CheckinHistoryService history) {
    ...
    @GetMapping
    public ApiResponse<CheckinHistoryResponse> getMyCheckinHistory(
