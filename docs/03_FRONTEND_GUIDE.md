...
설계는 [docs/29_MEMBER_INQUIRY_DESIGN.md](29_MEMBER_INQUIRY_DESIGN.md)를 따릅니다.
...
- **작성 폼에 개인정보 입력 자제 안내를 반드시 노출합니다.** 본문을 평문으로 저장하기 때문입니다
  (`docs/29` 3.1). 함께 "동행 중 문제는 신고 기능을 이용해 주세요"도 안내합니다 — 안전 카테고리를
  두지 않는 결정의 화면 쪽 대응입니다(`docs/29` 3.4).
